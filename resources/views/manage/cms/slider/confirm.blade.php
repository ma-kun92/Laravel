    ...
    <div class="inner">
      ...
      <div class="main">
        ...
        <section>
          ...
          @endif
          <form action="{{ url('/manage/cms/slider/end') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="form-body">
              {{ $data['name'] }}
              <br>
              <img src=" {{ asset($data['image']) }} " alt="" width=300px;>
              <br>
              {{ $data['caption'] }}
              <br>
              <button class="btn" name="flg" value="1">
                <i>戻る</i>
              </button>
              <button class="btn" name="flg" value="2">
                <i>登録</i>
              </button>
            </div>
          </form>

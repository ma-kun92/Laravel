  ...
  <div class="inner">
    ...
    <nav id="menubar">
      <ul class="inner">
        ...
        <li class="current"><a href="{{ url('/login/index') }}"><span>Contact</span>ログイン</a></li>
      </ul>
    </nav>
          ...
          <form name="form1" enctype="multipart/form-data" method="post" action="{{ url('/login/check') }}">
            ...
            <table class="">
              ...
              <tr>
                ...
                <td>
                <input name="email" id="email" value="{{ $data['email'] }}" type="text" maxlength="32" class="" placeholder="メールアドレス">
                </td>
              </tr>
              <tr>
                <th>パスワード<span class="red bold">※</span></th>
                <td>
                <input name="passwd" id="passwd" value="{{ $data['passwd'] }}" type="passward" maxlength="16" class="" placeholder="パスワード">
                </td>                      
              </tr>

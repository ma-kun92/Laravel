          ...
          <form name="form1" enctype="multipart/form-data" method="post" action="{{ url('/register/check') }}" class="h-adr">
            ...
            <table class="">
              <tr>
                ...
                <td>
                <input name="name_mei" id="name_mei" value="{{ $data['name_sei'] }}" type="text" maxlength="32" class="" placeholder="姓">
                <input name="name_sei" id="name_sei" value="{{ $data['name_mei'] }}" type="text" maxlength="32" class="" placeholder="名">
                </td>
              </tr>
              <tr>
                <th>ふりがな</th>
              ...
              <tr>
                ...
                <td>
                <input name="zip1" id="zip1" class="p-postal-code" type="text" maxlength="3" value="{{ $data['zip1'] }}" placeholder="000">
                <input name="zip2" id="zip2" class="p-postal-code" type="text" maxlength="4" value="{{ $data['zip2'] }}" placeholder="0000">

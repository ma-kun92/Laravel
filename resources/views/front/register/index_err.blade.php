          ...
          <form name="form1" enctype="multipart/form-data" method="post" action="{{ url('/register/check') }}" class="h-adr">
            ...
            <table class="">
              <tr>
                ...
                <td>
                <input name="name_sei" id="name_sei" value="{{ $data['name_sei'] ?? '' }}" type="text" maxlength="32" class="" placeholder="姓">
                <input name="name_mei" id="name_mei" value="{{ $data['name_mei']  ?? ''}}" type="text" maxlength="32" class="" placeholder="名">
                </td>
              </tr>
              <tr>
                <th>ふりがな</th>
                <td>
                <input name="name_sei_kana" id="name_sei_kana" value="{{$data['name_sei_kana'] ?? ''}}" type="text" maxlength="32" class="" placeholder="せい">
                <input name="name_mei_kana" id="name_mei_kana" value="{{$data['name_mei_kana'] ?? ''}}" type="text" maxlength="32" class="" placeholder="めい">
                </td>                      
              </tr>
              <tr>
                ...
                <td>
                @if($data['sex'] == '1') 
                <input name="sex" id="sex1" value="1" type="radio" checked="checked"><label for="sex1">男性</label>
                <input name="sex" id="sex2" value="2" type="radio"><label for="sex2">女性</label>
                @elseif ($data['sex'] == '2')
                <input name="sex" id="sex1" value="1" type="radio"><label for="sex1">男性</label>
                <input name="sex" id="sex2" value="2" type="radio" checked="checked" ><label for="sex2">女性</label>
                @else
                <input name="sex" id="sex1" value="1" type="radio"><label for="sex1">男性</label>
                <input name="sex" id="sex2" value="2" type="radio"><label for="sex2">女性</label>
                @endif
              ...
              <tr>
                ...
                <td>
                <input name="email" id="email" value="{{$data['email'] ?? ''}}" type="text" maxlength="128" class="" placeholder="info@example.com">
                </td>
              </tr>
              <tr>
                <th>パスワード<span class="red bold">※</span></th>
                <td>
                <input name="passwd" id="" value="{{ $data['passwd'] ?? '' }}" type="password" maxlength="32" class="wl">
                </td>
              </tr>
              <tr>
                <th>確認用パスワード<span class="red bold">※</span></th>
                <td>
                <input name="passwd_confirmation" id="" value="{{ $data['passwd_confirmation'] ?? '' }}" type="password" maxlength="32" class="wl">
                </td>
              </tr>
              <tr>
                <th>郵便番号<span class="red bold">※</span></th>
                <td>
                <input name="zip1" id="zip1" class="p-postal-code" value="{{ $data['zip1'] ?? '' }}" type="text" maxlength="3" class="" placeholder="000">
                <input name="zip2" id="zip2" class="p-postal-code" value="{{ $data['zip2'] ?? '' }}" type="text" maxlength="4" class="" placeholder="0000">
                <input type="button" value="住所反映">
                </td>
              </tr>
              <tr>
                <th>
              ...
              <tr>
                <th>備考</th>
                <td>
                <textarea name="comment" cols="40" rows="10" class="">{{ $data['comment'] ?? ''}}</textarea>
                </td>
              </tr>
            </table>
            <div class="c">

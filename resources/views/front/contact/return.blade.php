      ...
      <div class="main">
        ...
        <form action=" {{ url('/contact/check') }} " method="post">
          ...
          <table class="ta1">
            <tr>
              <th>お名前※</th>
              <td>姓：<input type="text" name="name_sei" size="30" class="wm" value="{{ $data['name_sei'] }}"></td>
              <td>名：<input type="text" name="name_mei" size="30" class="wm" value="{{ $data['name_mei'] }}"></td>
            </tr>
            <tr>
              <th>メールアドレス※</th>
              <td colspan='2'><input type="text" name="email" size="30" class="wm" value="{{ $data['email'] }}"></td>
            </tr>
            <tr>
              <th>お問い合わせ詳細※</th>
              <td colspan='2'><textarea name="content" cols="30" rows="10" class="wl">{{ $data['content'] }}</textarea></td>
            </tr>
          </table>
